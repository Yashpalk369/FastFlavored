...
RECIPES = [
    {
        ...
        "takeaways": [
                [
                        "Risotto-Style Starch Emulsion",
                        "Cooking dry orzo directly in broth releases natural starches, creating an authentic silky risotto mouthfeel in half the time."
                ],
                [
                        "Sweet Corn Milk Infusion",
                        "Saut\u00e9ing corn kernels in foaming butter extracts natural corn sugars that season every grain of pasta."
                ],
                [
                        "Two-Minute Shrimp Safeguard",
                        "Seared shrimp are removed before cooking the pasta, preventing overcooking and ensuring plump, juicy bites."
                ]
        ],
        ...
        "matrix_rows": [
                [
                        "Orzo Pasta",
                        "High (instant creaminess)",
                        "8\u20139 minutes",
                        "Exceptional (spoons like risotto)",
                ...
                [
                        ...
                        "Medium",
                        "10\u201312 minutes",
                        "Requires separate twirling",
                        "Lacks risotto-like cohesive texture"
                ],
                [
                        "Angel Hair",
                        "Low",
                        "5 minutes",
                        "Fragile in heavy sauce",
                        "Cooks too fast for corn reduction"
                ]
        ],
        "ingredients": [
        ...
        "instructions": [
                [
                        "Sear Jumbo Shrimp",
                        "Heat olive oil and 1 tbsp butter in a large 12-inch skillet over medium-high heat. Season shrimp with 1/2 tsp salt and 1/4 tsp pepper. Add shrimp to the hot pan and sear for 2 minutes on the first side, flip and cook 1 minute until pink and opaque. Transfer shrimp to a clean plate."
                ],
                [
                        "Saut\u00e9 Corn & Garlic",
                        "In the same skillet, melt remaining 2 tbsp butter over medium heat. Add sweet corn kernels and minced garlic; saut\u00e9 for 2 minutes until corn begins to blister and garlic is fragrant."
                ],
                [
                        "Toast Orzo",
                        "Pour in dry orzo pasta directly into the buttery corn skillet. Stir continuously for 1 minute to lightly toast the grains in the garlic butter."
                ],
                [
                        "Simmer into Creamy Orzotto",
                        "Pour in chicken broth and heavy cream. Bring to a lively simmer, then lower heat to medium-low. Cook uncovered for 8\u20139 minutes, stirring frequently with a wooden spoon so the orzo doesn't stick, until pasta is al dente and sauce is thick and creamy."
                ],
                [
                        "Fold Cheese & Serve",
                        "Remove skillet from heat. Stir in grated Parmigiano-Reggiano, lemon juice, lemon zest, and half the fresh basil. Arrange the seared shrimp on top, season with cracked black pepper, and garnish with remaining basil ribbons. Serve piping hot!"
                ]
        ],
        ...
        "faqs": [
                [
                        ...
                        "Yes! Replace butter with extra olive oil, substitute canned full-fat coconut milk for heavy cream, and use dairy-free parmesan or nutritional yeast."
                ],
                [
                        "Can I use frozen or canned corn?",
                        "Yes! Frozen sweet corn (especially sweet petite or fire-roasted corn) works brilliantly. If using canned corn, drain and pat dry thoroughly before saut\u00e9ing."
                ],
                [
                        "Can I use chicken or scallops instead of shrimp?",
                        "Absolutely! Diced chicken breast cutlets or sea scallops sear wonderfully in 2\u20133 minutes and pair exquisitely with the sweet corn orzo."
                ]
        ],
        "wiki_entities": [
                [
...
},
    {
        ...
        "takeaways": [
                [
                        "Cornstarch-Panko Duo",
                        "Cornstarch creates a glass-like barrier that keeps the chicken juicy, while coarse panko delivers an airy, stay-crisp exterior shell."
                ],
                [
                        "Lemon Pepper Zing Balance",
                        "Citric acid and pungent black pepper in the seasoning cut through sweet wildflower honey, preventing cloying heaviness."
                ],
                [
                        "Wire Rack Rest Technique",
                        "Resting freshly fried cutlets on a wire rack ensures 360-degree air circulation, preventing soggy bottom crusts."
                ]
        ],
        ...
        "matrix_rows": [
                [
                        ...
                        "Bright, aromatic citrus",
                        "Perfect harmony with pepper",
                        "Mirror gloss",
                        "Gold Standard Winner (Recommended)"
                ],
                [
                        "Apple Cider Vinegar",
                        "Sharp, fruity fermented tang",
                        "Southern BBQ profile",
                        "Glossy",
                        "Great bold alternative"
                ],
                [
                        "Hot Sauce (Frank's / Louisiana)",
                        "Direct vinegar heat",
                        "Punchy spicy kick",
                        "Deep amber",
                        "Classic wing-style flavor"
                ],
                [
                        "Balsamic Vinegar",
                        "Sweet & complex",
        ...
        "instructions": [
                [
                        "Prep Breading Trio",
                        "Set up three shallow bowls: Bowl 1 with cornstarch, 1/2 tsp salt, and garlic powder; Bowl 2 with beaten eggs; Bowl 3 with panko mixed with lemon pepper seasoning and smoked paprika."
                ],
                [
                        "Dredge Cutlets",
                        "Dredge each chicken cutlet first in cornstarch, shake off excess, dip into egg wash, then press firmly into the lemon pepper panko so crumbs adhere evenly."
                ],
                [
                        "Pan-Fry Until Golden",
                        "Heat oil in a large 12-inch skillet over medium-high heat until shimmering. Add chicken cutlets in a single layer (cook in batches if needed). Fry for 3\u20134 minutes per side until deeply golden, crispy, and internal temperature reads 165\u00b0F. Transfer to an elevated wire rack."
                ],
                [
                        "Warm Hot Honey Glaze",
                        "In a small saucepan over low heat, whisk together honey, melted butter, red pepper flakes (or hot sauce), lemon juice, and lemon zest for 1\u20132 minutes until warm, fluid, and glossy."
                ],
                [
                        "Glaze & Garnish",
                        "Arrange crispy cutlets on a serving platter. Generously brush or drizzle the warm hot honey glaze over the sizzling chicken. Scatter fresh thyme leaves and flaky sea salt on top. Serve immediately!"
                ]
        ],
        ...
        "faqs": [
                [
                        ...
                        "Yes! Preheat air fryer to 390\u00b0F. Spray breaded cutlets lightly with cooking spray and air fry for 10\u201312 minutes, flipping halfway. Drizzle with glaze right before serving."
                ],
                [
                        "What if my lemon pepper seasoning has salt?",
                        "If using a salted lemon pepper blend, omit the added kosher salt in the cornstarch bowl to keep sodium levels perfectly balanced."
                ],
                [
                        "Can I use chicken tenders or bone-in thighs?",
                        "Chicken tenders cook in 6\u20138 minutes total! For bone-in thighs, bake at 400\u00b0F for 25 minutes after crisping."
                ]
        ],
        "wiki_entities": [
                [
                        "Hot honey",
                        "https://en.wikipedia.org/wiki/Hot_honey"
                ],
                [
                        "Lemon pepper",
                        "https://en.wikipedia.org/wiki/Lemon_pepper"
                ],
                [
                        "Fried chicken",
...
},
    {
        ...
        "takeaways": [
                [
                        "Warm Spice Blend Magic",
                        "Pairing savory cumin and coriander with sweet ground cinnamon delivers intoxicating authentic North African aroma in minutes."
                ],
                [
                        "High-Heat Blistering",
                        "Roasting at 425\u00b0F caramelizes meatball fat while bursting tomatoes into natural sweet savory sauce."
                ],
                [
                        "Lemon Tahini Sauce Creaminess",
                        "Nutty sesame tahini emulsified with lemon juice and ice water creates an unctuous sauce with zero dairy."
                ]
        ],
        ...
        "matrix_rows": [
                [
                        "80/20 Ground Beef + Ground Lamb",
                        "Medium-High",
                        "Rich, gamey & traditional",
                        "Ultra-tender & juicy",
                        "Gold Standard Authentic Pick (Recommended)"
                ],
                [
                        "85/15 Ground Beef Only",
                        "Medium",
                        "Savory & comforting",
                        "Very tender",
                        "Best accessible weeknight choice"
                ],
                [
                        "Ground Turkey (Dark Meat)",
                        "Medium-Low",
                        "Mild, takes spices well",
                        "Tender (add extra olive oil)",
                        "Great lighter alternative"
                ],
                [
                        "Lean Ground Beef (90/10)",
                        "Low",
                        "Beefy but can dry out",
                        "Firm",
                        "Requires grated onion for moisture"
                ]
        ],
        "ingredients": [
        ...
        "instructions": [
                [
                        "Preheat Oven & Season Meat",
                        "Preheat oven to 425\u00b0F (220\u00b0C). Line a large rimmed baking sheet with parchment paper. In a bowl, combine ground meat, panko, egg, half the minced garlic, cumin, coriander, cinnamon, paprika, cayenne, 1 tsp salt, and 1/2 tsp pepper. Mix gently until combined (do not overwork)."
                ],
                [
                        "Shape & Arrange Pan",
                        "Roll meat into 16 golf ball-sized meatballs (about 1.5 inches). Place on the baking sheet. Scatter cherry tomatoes and sliced red onions around the meatballs. Drizzle vegetables with 1 tbsp olive oil and a pinch of salt."
                ],
                [
                        "Roast to Golden Perfection",
                        "Roast at 425\u00b0F for 12\u201314 minutes, switching to high broil for the final 2 minutes until meatballs are deeply browned and caramelized and internal temperature reaches 160\u00b0F."
                ],
                [
                        "Whisk Creamy Lemon Tahini",
                        "While pan roasts, whisk tahini paste, remaining minced garlic, lemon juice, 1 tbsp olive oil, a pinch of salt, and 2\u20133 tbsp warm water in a small bowl until smooth, creamy, and pourable."
                ],
                [
                        "Assemble & Serve",
                        "Tuck warm pita bread wedges onto the sheet pan or serving platter. Drizzle creamy lemon tahini generously over the sizzling meatballs and burst tomatoes. Garnish with chopped fresh mint and toasted pine nuts. Serve immediately!"
                ]
        ],
        ...
        "faqs": [
                [
                        ...
                        "Yes! Shape raw meatballs and freeze on a baking sheet for 1 hour, then store in a freezer bag for up to 3 months. Bake straight from frozen at 400\u00b0F for 18\u201320 minutes."
                ],
                [
                        "What can I use if I don't have tahini?",
                        "Greek yogurt whisked with lemon juice, grated garlic, and a drop of olive oil makes an incredible, zesty cooling sauce!"
                ],
                [
                        "Can I cook these in an air fryer?",
                        "Yes! Air fry meatballs at 380\u00b0F for 9\u201310 minutes, shaking the basket halfway through."
                ]
        ],
        "wiki_entities": [
                [
...
},
    {
        ...
        "takeaways": [
                [
                        "Zero Water Boil Shortcut",
                        "Roasting shelf-stable gnocchi dry on a sheet pan creates a crunchy, blistered exterior shell and a light cloud-like center."
                ],
                [
                        "Tomato-Pesto Pan Emulsion",
                        "Tossing burst tomato juices with fragrant basil pesto directly on the hot sheet pan creates an effortless pan sauce."
                ],
                [
                        "Molten Burrata Centerpiece",
                        "Tearing cold, creamy burrata cheese over the sizzling hot gnocchi creates a decadent, temperature-contrasting sauce."
                ]
        ],
        ...
        "matrix_rows": [
                [
                        "Fresh Burrata (Whole Ball)",
                        "Liquid stracciatella cream center",
                        "Melts into luxurious sauce",
                        "Spectacular table centerpiece",
                        "Gold Standard Winner (Recommended)"
                ],
                [
                        ...
                        "Mild & milky",
                        "Gooey stringy melt",
                        "Evenly distributed bites",
                        "Great everyday budget substitute"
                ],
                [
                        "Whole Milk Ricotta Dollops",
                        "Dense & velvety",
                        "Warm dollops without melting",
                ...
                [
                        ...
                        "Coats crispy edges",
                        "Subtle garnish",
                        "Add alongside burrata for depth"
                ]
        ],
        "ingredients": [
        ...
        "instructions": [
                [
                        ...
                        "Preheat oven to 425\u00b0F (220\u00b0C). Line a large heavy-rimmed baking sheet with parchment paper for easy cleanup."
                ],
                [
                        "Toss Gnocchi & Tomatoes",
                        "Scatter uncooked gnocchi and whole cherry tomatoes across the baking sheet. Add sliced garlic. Drizzle with 2 tbsp extra virgin olive oil and season with Italian herbs, red pepper flakes, 1/2 tsp salt, and 1/4 tsp pepper. Toss well with your hands and spread into an even, single layer."
                ],
                [
                        "Roast Until Crispy & Blistered",
                        "Roast at 425\u00b0F for 15\u201318 minutes, shaking the pan once halfway through. Gnocchi should be puffed and golden with crispy edges, and tomatoes should be charred and bursting with juice."
                ],
                [
                        "Dollop Pesto",
                        "Remove the baking sheet from the oven. Spoon dollops of basil pesto over the hot gnocchi and gently stir with a spatula so the sweet burst tomato juices and pesto meld into a rich pan sauce."
                ],
                [
                        "Crown with Burrata & Serve",
                        "Place the ball of burrata directly in the center of the hot gnocchi. Use two forks or a knife to gently tear open the burrata ball, spilling the luscious, creamy stracciatella cheese over the crispy dumplings. Scatter toasted pine nuts, torn fresh basil, flaky sea salt, and a drizzle of balsamic glaze. Serve immediately!"
                ]
        ],
        ...
        "faqs": [
                [
                        ...
                        "NO! Boiling gnocchi before roasting ruins the crisp texture. Roast shelf-stable gnocchi dry right out of the package\u2014the steam trapped in the oven cooks the interior while roasting the exterior."
                ],
                [
                        "Can I add protein like chicken or sausage?",
                        "Yes! Slice 2 cooked Italian sausages or toss in 1 cup of shredded rotisserie chicken during the final 3 minutes of roasting to warm through."
                ],
                [
                        "What if I don't have burrata?",
                        "Tear a 6 oz ball of fresh mozzarella into chunks or dollop whole-milk ricotta across the pan right after it comes out of the oven."
                ]
        ],
        "wiki_entities": [
                [
...
},
    {
        ...
        "takeaways": [
                [
                        "Cubed Salmon Surface Area",
                        "Cutting salmon into 1-inch cubes quadruples the caramelized crispy surface area compared to whole fillets."
                ],
                [
                        "Cornstarch Searing Lock",
                        "A light dusting of cornstarch prevents salmon from shedding albumin (white protein), guaranteeing a crunchy crust."
                ],
                [
                        "Sesame Cucumber Balance",
                        "Cold, crunchy, vinegar-dressed cucumbers provide refreshing textural and acidic contrast against rich omega-3 glazed fish."
                ]
        ],
        ...
        "matrix_rows": [
                [
                        "1-Inch Cubes (Bites)",
                        "3 minutes total",
                        "360-degree full coating",
                        "Maximum (4 crispy sides)",
                        "Gold Standard Winner (Recommended)"
                ],
                [
                        "Whole Skin-On Fillets",
                        "8\u201310 minutes",
                        "Top glaze only",
                        "Crispy skin only",
                        "Classic, but slower cook time"
                ],
                [
                        "Thin Salmon Cutlets",
                        "4 minutes",
                        "Top & bottom",
                        "Moderate",
                        "Great for burgers or wraps"
                ],
                [
                        "Salmon Skewers",
                        "6 minutes",
                        "Good coverage",
                        "Requires threading skewers",
                        "Fun for grilling"
                ]
        ],
        "ingredients": [
        ...
        "instructions": [
                [
                        "Dry & Dust Salmon Bites",
                        "Pat cubed salmon thoroughly dry with paper towels. Place in a medium bowl, sprinkle with 1 tbsp cornstarch, 1/2 tsp salt, and 1/4 tsp black pepper. Toss gently until each cube is lightly and evenly coated."
                ],
                [
                        "Whisk Quick Teriyaki Glaze",
                        "In a measuring cup or small bowl, whisk together soy sauce, brown sugar, mirin, sesame oil, minced garlic, and grated ginger until sugar dissolves."
                ],
                [
                        "Flash-Sear Salmon Bites",
                        "Heat neutral oil in a large 12-inch nonstick or cast-iron skillet over medium-high heat until shimmering. Add salmon cubes in a single layer with space between them. Sear undisturbed for 2 minutes until bottoms develop a deeply caramelized, crispy crust. Flip and sear 1 more minute. Transfer salmon to a plate."
                ],
                [
                        "Bubble Teriyaki Sauce",
                        "Lower heat to medium. Pour the teriyaki sauce mixture into the empty hot skillet. Let it bubble vigorously for 1\u20132 minutes, stirring constantly as it reduces into a thick, glossy syrup that coats the back of a spoon."
                ],
                [
                        "Glaze Salmon & Assemble",
                        "Return crispy salmon cubes to the skillet. Toss gently for 30 seconds until every piece is coated in shiny teriyaki glaze. Remove from heat immediately."
                ],
                [
                        "Prep Cucumbers & Serve",
                        "Toss sliced cucumbers with rice vinegar, sesame seeds, and a pinch of salt. Spoon warm jasmine rice into bowls, top with glistening teriyaki salmon bites and crunchy cucumbers, and garnish with sliced scallions and sesame seeds!"
                ]
        ],
        ...
        "faqs": [
                [
                        ...
                        "Yes! Air fry salmon cubes at 400\u00b0F for 6\u20137 minutes until crispy, then toss in the simmering teriyaki glaze."
                ],
                [
                        "How do I avoid overcooking salmon bites?",
                        "Because the cubes are bite-sized, they cook in just 3 minutes total! Pull them from the heat while the centers are still tender and coral-pink."
                ],
                [
                        "Can I use frozen salmon?",
                        "Yes! Thaw completely in the refrigerator, and make sure to pat thoroughly dry with paper towels before tossing with cornstarch."
                ]
        ],
        "wiki_entities": [
                [
...
},
    {
        ...
        "takeaways": [
                [
                        "One-Pot Milk-Broth Starch Base",
                        "Cooking pasta directly in milk and chicken broth locks in all the pasta starch, creating an ultra-creamy base without making a flour roux."
                ],
                [
                        "Sharp White Cheddar & Gruy\u00e8re Duo",
                        "Sharp white cheddar provides deep tangy punch while alpine gruy\u00e8re delivers a dramatic, gooey cheese pull."
                ],
                [
                        "Bacon-Infused Panko Crunch",
                        "Toasting panko breadcrumbs in rendered bacon fat provides crucial crispy texture contrast against velvety cheese sauce."
                ]
        ],
        ...
        "matrix_rows": [
                [
                        "Sharp White Cheddar + Gruy\u00e8re",
                        "Silky & velvety",
                        "Robust & tangy",
                        "Exceptional stringy pull",
                        "Gold Standard Winner (Recommended)"
                ],
                [
                        ...
                        "Mild & buttery",
                        "High pull",
                        "Classic kid-friendly substitute"
                ],
                [
                        "Smoked Gouda + White Cheddar",
                        "Rich & creamy",
                        "Deep smoky wood notes",
                        "Medium pull",
                        "Fabulous gourmet variation"
                ],
                [
                        "Pre-Shredded Bagged Cheddar",
                        "Gritty & grainy melt",
                        "Low flavor",
                        "Poor",
                        "Not recommended (wood pulp coating)"
                ]
        ],
        "ingredients": [
        ...
        "instructions": [
                [
                        "Crisp Bacon & Toast Panko",
                        "In a deep 12-inch skillet over medium heat, fry chopped bacon for 5 minutes until deeply crispy. Transfer bacon with a slotted spoon to a paper towel-lined plate, reserving 1 tbsp bacon drippings in pan. Add 1 tbsp butter and 1/2 cup panko to the skillet; stir for 2 minutes until golden brown and toasted. Transfer panko to a small bowl."
                ],
                [
                        "Combine Pasta, Milk & Broth",
                        "In the same skillet, add dry macaroni, chicken broth, whole milk, remaining 1 tbsp butter, Dijon mustard, garlic powder, onion powder, ground mustard, 1/2 tsp salt, and 1/4 tsp black pepper. Stir well."
                ],
                [
                        "Simmer Directly in Skillet",
                        "Bring liquid to a boil over medium-high heat. Once boiling, immediately lower heat to medium-low. Simmer uncovered for 9\u201310 minutes, stirring frequently with a wooden spoon to prevent pasta from sticking to the bottom, until macaroni is tender and liquid has reduced into a thick, bubbly starchy cream."
                ],
                [
                        "Melt the Cheeses",
                        "Turn off the heat completely. Gradually fold in freshly grated sharp white cheddar and shredded Gruy\u00e8re, one handful at a time, stirring gently until cheese is fully melted into an ultra-smooth, velvety sauce."
                ],
                [
                        "Garnish & Serve",
                        "Scatter the crispy bacon crumbles, golden toasted garlic panko breadcrumbs, and fresh chopped chives across the top. Serve immediately while hot and bubbly!"
                ]
        ],
        ...
        "faqs": [
                [
                        ...
                        "Yes, but low-sodium chicken broth adds tremendous savory depth and richness that water cannot match."
                ],
                [
                        "Can I make this ahead or reheat leftovers?",
                        "Store in an airtight container for up to 4 days. Reheat gently in a saucepan with a splash of milk over low heat to restore the creamy sauce consistency."
                ],
                [
                        "Can I bake it with extra cheese on top?",
                        "Yes! Pop the skillet under the broiler for 2\u20133 minutes after adding the panko and bacon for bubbly browned peaks."
                ]
        ],
        "wiki_entities": [
                [
